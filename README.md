...
3. **Bug fix for Ultrasonic Block** Fixed an issue where the ultrasonic distance block was not translated correctly.
---
...
3. **초음파 블록 버그 수정** 초음파 거리 블록의 번역이 적용되지 않던 문제를 수정했습니다.
---
