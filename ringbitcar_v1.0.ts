...
namespace RingbitCar {
    ...
    */
    ...
    /**
    * Sets the motor speed. Default is 70 to prevent overheating.
    * This applies to all blocks except steering_angle, freestyle
    */
    //% weight=98
    //% blockId=ringbitcar_set_speed block="set motor speed to %speed"
    export function set_motor_speed(speed: Motor_Speed): void {
        switch (speed) {
            case Motor_Speed.Speed_20: motor_speed = 20; break;
            case Motor_Speed.Speed_30: motor_speed = 30; break;
            case Motor_Speed.Speed_50: motor_speed = 50; break;
            case Motor_Speed.Speed_70: motor_speed = 70; break;
            case Motor_Speed.Speed_100: motor_speed = 100; break;
        }
    }

    /**
    *For reference only
    * This block already has its own limit (approximately 45%).
    */
    //% weight=25
    ...
    */
    ...
    export function forward(): void {
        // 1500 = stop , 2400 = full speed
        // Use 1600 and 1400 as starting points to avoid dead zones as in freestyle.
        pins.servoSetPulse(pin_left_wheel, 1600 + (motor_speed * 8))
        pins.servoSetPulse(pin_right_wheel, 1400 - (motor_speed * 8))
    }
    ...
    */
    ...
    export function back(): void {
        pins.servoSetPulse(pin_left_wheel, 1400 - (motor_speed * 8))
        pins.servoSetPulse(pin_right_wheel, 1600 + (motor_speed * 8))
    }
